export const pendingPaymentTemplate = (user, checkoutUrl) => {
  return `
  <!DOCTYPE html>
  <html>
    <head>
      <meta charset="UTF-8" />
      <title>Payment Pending - Aamana Classroom</title>
    </head>
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 2px 6px rgba(0,0,0,0.1);">
              ...
              <tr>
                <td style="padding:30px; color:#333;">
                  ...
                  <p>Your account is pending activation. Please complete your payment to unlock full access.</p>
